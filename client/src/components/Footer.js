        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              <h3 className="text-2xl font-bold text-white">Rydigo</h3>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              Your trusted bike rental platform. Find and rent bikes easily and safely 
              from verified owners across India. Experience the freedom of two wheels.
            </p>
            ...
            <div className="mb-6">
              ...
              <div className="space-y-2 text-gray-400">
                <div className="flex items-center">
                  ...
                  <span>+91-7004904661</span>
                </div>
                <div className="flex items-center">
                  <svg className="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span>support@rentrider.com</span>
                </div>
                <div className="flex items-center">
                  <svg className="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
                ...
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path fillRule="evenodd" d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.621 5.367 11.988 11.988 11.988s11.987-5.367 11.987-11.988C24.004 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.348-.49-3.185-1.297L3.891 16.924c-.654-.654-1.056-1.556-1.056-2.551 0-.995.402-1.897 1.056-2.551l1.373-1.233c.837-.807 1.888-1.297 3.185-1.297s2.348.49 3.185 1.297l1.373 1.233c.654.654 1.056 1.556 1.056 2.551 0 .995-.402 1.897-1.056 2.551l-1.373 1.232c-.837.808-1.888 1.297-3.185 1.297z"/>
                </svg>
              </a>
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
