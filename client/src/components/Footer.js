        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              <span className="text-2xl font-bold">RentRider</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/vehicles" className="text-gray-300 hover:text-white">Browse Bikes</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="mailto:support@rentrider.com" className="text-gray-300 hover:text-white">Email Support</a></li>
              <li><a href="tel:+911234567890" className="text-gray-300 hover:text-white">Phone Support</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <Link to="/terms-of-service" className="text-gray-400 hover:text-white text-sm">Terms</Link>
              <Link to="/cookie-policy" className="text-gray-400 hover:text-white text-sm">Cookies</Link>
            </div>
          </div>
        </div>
      </div>
